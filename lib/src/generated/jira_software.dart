...
class JiraSoftwareApi {
  ...
  ///
  /// These APIs are available to Atlassian Connect apps. To use these APIs you
  /// must have the `jiraBuildInfoProvider` module in your Connect app's
  /// descriptor. See
  /// https://developer.atlassian.com/cloud/jira/software/modules/build/. They
  /// are also related to integrating Jira Software Cloud with on-premises tools
  ...
  ///
  /// These APIs are available to Atlassian Connect apps. To use these APIs you
  /// must have the `jiraDeploymentInfoProvider` module in your Connect app's
  /// descriptor. See
  /// https://developer.atlassian.com/cloud/jira/software/modules/deployment/.
  /// They are also related to integrating Jira Software Cloud with on-premises
  /// tools using OAuth 2.0 credentials. See
  /// https://developer.atlassian.com/cloud/jira/software/integrate-jsw-cloud-with-onpremises-tools/.
  ///
  /// These APIs are available to Forge apps with the
  /// `devops:deploymentInfoProvider` module in the Forge app's manifest. See
  ...
  ///
  /// These APIs are available to Atlassian Connect apps. To use these APIs you
  /// must have the `jiraDevOpsComponentProvider` in your Connect app's
  /// descriptor. See
  ...
  /// pull requests) with Jira.
  ///
  /// These APIs are available to Atlassian Connect apps and on-premise
  /// integrations using OAuth. Connect apps using these APIs must have the
  /// `jiraDevelopmentTool` module in the Connect app descriptor. See
  ...
  ///
  /// These APIs are available to Atlassian Connect apps. To use these APIs you
  /// must have the `jiraFeatureFlagInfoProvider` module in your Connect app's
  /// descriptor. See
  ...
  ///
  /// These APIs are available to Atlassian Connect apps. To use these APIs you
  /// must have the `jiraOperationsInfoProvider` module in your Connect app's
  /// descriptor. See
  ...
  ///
  /// These APIs are available to Atlassian Connect apps. To use these APIs you
  /// must have the `jiraRemoteLinkInfoProvider` module in your Connect app's
  /// descriptor. See
  /// https://developer.atlassian.com/cloud/jira/software/modules/remote-link/.
  ///
  /// These APIs are available to Forge apps with the
  /// `devops:remoteLinkInfoProvider` module in the Forge app's manifest. See
...
class EntityAssociation {
  /// Defines the association type. Currently supported entities can be found in
  /// this field's value enums list.
  final EntityAssociationAssociationType associationType;
  ...
  EntityAssociation({required this.associationType, required this.values});

  factory EntityAssociation.fromJson(Map<String, Object?> json) {
    return EntityAssociation(
      associationType: EntityAssociationAssociationType.fromValue(
          json[r'associationType'] as String? ?? ''),
      values: (json[r'values'] as List<Object?>?)?.map((i) => i).toList() ?? [],
    );
  }

  Map<String, Object?> toJson() {
    var associationType = this.associationType;
    var values = this.values;

    final json = <String, Object?>{};
    json[r'associationType'] = associationType.value;
    json[r'values'] = values;
    return json;
  }

  EntityAssociation copyWith(
      {EntityAssociationAssociationType? associationType,
      List<dynamic>? values}) {
    return EntityAssociation(
...
class EntityAssociationAssociationType {
  static const commit = EntityAssociationAssociationType._('commit');
  static const repository = EntityAssociationAssociationType._('repository');
  ...
  const EntityAssociationAssociationType._(this.value);

  static EntityAssociationAssociationType fromValue(String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => EntityAssociationAssociationType._(value));
...
class IssueIdOrKeysAssociation {
  ...
  final IssueIdOrKeysAssociationAssociationType associationType;
  ...
  IssueIdOrKeysAssociation(
      {required this.associationType, required this.values});

  factory IssueIdOrKeysAssociation.fromJson(Map<String, Object?> json) {
    return IssueIdOrKeysAssociation(
      associationType: IssueIdOrKeysAssociationAssociationType.fromValue(
          json[r'associationType'] as String? ?? ''),
  ...
  IssueIdOrKeysAssociation copyWith(
      {IssueIdOrKeysAssociationAssociationType? associationType,
      List<String>? values}) {
    return IssueIdOrKeysAssociation(
      associationType: associationType ?? this.associationType,
      values: values ?? this.values,
...
class IssueIdOrKeysAssociationAssociationType {
  static const issueKeys =
      IssueIdOrKeysAssociationAssociationType._('issueKeys');
  static const issueIdOrKeys =
      IssueIdOrKeysAssociationAssociationType._('issueIdOrKeys');
  ...
  const IssueIdOrKeysAssociationAssociationType._(this.value);

  static IssueIdOrKeysAssociationAssociationType fromValue(String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => IssueIdOrKeysAssociationAssociationType._(value));
...
class JiraSoftwareChangelog {
  ...
  final List<JiraSoftwareChangelogItemsItem> items;

  JiraSoftwareChangelog(
      {this.author,
      this.created,
      this.historyMetadata,
      this.id,
      List<JiraSoftwareChangelogItemsItem>? items})
      : items = items ?? [];

  factory JiraSoftwareChangelog.fromJson(Map<String, Object?> json) {
    return JiraSoftwareChangelog(
      ...
      items: (json[r'items'] as List<Object?>?)
              ?.map((i) => JiraSoftwareChangelogItemsItem.fromJson(
                  i as Map<String, Object?>? ?? const {}))
              .toList() ??
          [],
    );
  ...
  JiraSoftwareChangelog copyWith(
...
/// A change item.
class JiraSoftwareChangelogItemsItem {
  /// The name of the field changed.
  final String? field;
  ...
  JiraSoftwareChangelogItemsItem(
      {this.field,
      this.fieldId,
      this.fieldtype,
      this.from,
  ...
  factory JiraSoftwareChangelogItemsItem.fromJson(Map<String, Object?> json) {
    return JiraSoftwareChangelogItemsItem(
      field: json[r'field'] as String?,
      fieldId: json[r'fieldId'] as String?,
      fieldtype: json[r'fieldtype'] as String?,
      from: json[r'from'] as String?,
  ...
  JiraSoftwareChangelogItemsItem copyWith(
      {String? field,
      String? fieldId,
      String? fieldtype,
      String? from,
...
class JiraSoftwareFieldMetadata {
  ...
  factory JiraSoftwareFieldMetadata.fromJson(Map<String, Object?> json) {
    return JiraSoftwareFieldMetadata(
      allowedValues:
  ...
  JiraSoftwareFieldMetadata copyWith(
      {List<dynamic>? allowedValues,
...
class JiraSoftwareHistoryMetadata {
  ...
  factory JiraSoftwareHistoryMetadata.fromJson(Map<String, Object?> json) {
    return JiraSoftwareHistoryMetadata(
  ...
  JiraSoftwareHistoryMetadata copyWith(
...
class JiraSoftwareHistoryMetadataParticipant {
  ...
  JiraSoftwareHistoryMetadataParticipant(
      {this.avatarUrl,
      this.displayName,
      this.displayNameKey,
      this.id,
  ...
  factory JiraSoftwareHistoryMetadataParticipant.fromJson(
      Map<String, Object?> json) {
    return JiraSoftwareHistoryMetadataParticipant(
  ...
  JiraSoftwareHistoryMetadataParticipant copyWith(
      {String? avatarUrl,
      String? displayName,
...
class JiraSoftwareIncludedFields {
  final List<String> actuallyIncluded;
  final List<String> excluded;
  final List<String> included;

  JiraSoftwareIncludedFields(
  ...
  factory JiraSoftwareIncludedFields.fromJson(Map<String, Object?> json) {
    return JiraSoftwareIncludedFields(
  ...
  JiraSoftwareIncludedFields copyWith(
      {List<String>? actuallyIncluded,
      List<String>? excluded,
      List<String>? included}) {
    return JiraSoftwareIncludedFields(
...
class JiraSoftwareIssueBean {
  ...
  final JiraSoftwareIssueBeanFieldsToInclude? fieldsToInclude;
  ...
  final JiraSoftwareOperations? operations;
  ...
  final List<JiraSoftwareIssueBeanTransitionsItem> transitions;

  /// The versions of each field on the issue.
  final Map<String, dynamic>? versionedRepresentations;

  JiraSoftwareIssueBean(
      {this.changelog,
      this.editmeta,
      this.expand,
      this.fields,
      ...
      this.schema,
      this.self,
      List<JiraSoftwareIssueBeanTransitionsItem>? transitions,
      this.versionedRepresentations})
      : transitions = transitions ?? [];

  factory JiraSoftwareIssueBean.fromJson(Map<String, Object?> json) {
    return JiraSoftwareIssueBean(
      ...
      fieldsToInclude: json[r'fieldsToInclude'] != null
          ? JiraSoftwareIssueBeanFieldsToInclude.fromJson(
      ...
      operations: json[r'operations'] != null
          ? JiraSoftwareOperations.fromJson(
      ...
      transitions: (json[r'transitions'] as List<Object?>?)
              ?.map((i) => JiraSoftwareIssueBeanTransitionsItem.fromJson(
                  i as Map<String, Object?>? ?? const {}))
              .toList() ??
          [],
  ...
  JiraSoftwareIssueBean copyWith(
      {Map<String, dynamic>? changelog,
      Map<String, dynamic>? editmeta,
      String? expand,
      Map<String, dynamic>? fields,
      JiraSoftwareIssueBeanFieldsToInclude? fieldsToInclude,
      String? id,
      String? key,
      Map<String, dynamic>? names,
      JiraSoftwareOperations? operations,
...
class JiraSoftwareIssueBeanFieldsToInclude {
  final List<String> actuallyIncluded;
  final List<String> excluded;
  final List<String> included;

  JiraSoftwareIssueBeanFieldsToInclude(
      {List<String>? actuallyIncluded,
      List<String>? excluded,
      List<String>? included})
      : actuallyIncluded = actuallyIncluded ?? [],
  ...
  factory JiraSoftwareIssueBeanFieldsToInclude.fromJson(
      Map<String, Object?> json) {
    return JiraSoftwareIssueBeanFieldsToInclude(
      actuallyIncluded: (json[r'actuallyIncluded'] as List<Object?>?)
              ?.map((i) => i as String? ?? '')
              .toList() ??
          [],
  ...
  JiraSoftwareIssueBeanFieldsToInclude copyWith(
      {List<String>? actuallyIncluded,
      List<String>? excluded,
      List<String>? included}) {
    return JiraSoftwareIssueBeanFieldsToInclude(
...
class JiraSoftwareIssueBeanTransitionsItem {
  ...
  JiraSoftwareIssueBeanTransitionsItem(
      {this.expand,
      this.fields,
      bool? hasScreen,
      this.id,
  ...
  factory JiraSoftwareIssueBeanTransitionsItem.fromJson(
      Map<String, Object?> json) {
    return JiraSoftwareIssueBeanTransitionsItem(
      expand: json[r'expand'] as String?,
      fields: json[r'fields'] as Map<String, Object?>?,
  ...
  JiraSoftwareIssueBeanTransitionsItem copyWith(
      {String? expand,
      Map<String, dynamic>? fields,
      bool? hasScreen,
      String? id,
...
/// Details of an issue transition.
class JiraSoftwareIssueTransition {
  /// Expand options that include additional transition details in the response.
  final String? expand;
  ...
  factory JiraSoftwareIssueTransition.fromJson(Map<String, Object?> json) {
    return JiraSoftwareIssueTransition(
      expand: json[r'expand'] as String?,
      fields: json[r'fields'] as Map<String, Object?>?,
      hasScreen: json[r'hasScreen'] as bool? ?? false,
      id: json[r'id'] as String?,
  ...
  JiraSoftwareIssueTransition copyWith(
      {String? expand,
      Map<String, dynamic>? fields,
      bool? hasScreen,
      String? id,
...
class JiraSoftwareIssueUpdateMetadata {
  final Map<String, dynamic>? fields;

  JiraSoftwareIssueUpdateMetadata({this.fields});

  factory JiraSoftwareIssueUpdateMetadata.fromJson(Map<String, Object?> json) {
    return JiraSoftwareIssueUpdateMetadata(
      fields: json[r'fields'] as Map<String, Object?>?,
    );
  }
  ...
  JiraSoftwareIssueUpdateMetadata copyWith({Map<String, dynamic>? fields}) {
    return JiraSoftwareIssueUpdateMetadata(
      fields: fields ?? this.fields,
    );
  }
...
class JiraSoftwareJsonTypeBean {
  ...
  factory JiraSoftwareJsonTypeBean.fromJson(Map<String, Object?> json) {
    return JiraSoftwareJsonTypeBean(
      configuration: json[r'configuration'] as Map<String, Object?>?,
  ...
  JiraSoftwareJsonTypeBean copyWith(
      {Map<String, dynamic>? configuration,
      String? custom,
      int? customId,
      String? items,
...
class JiraSoftwareOperations {
  /// Details of the link groups defining issue operations.
  final List<LinkGroup> linkGroups;

  JiraSoftwareOperations({List<LinkGroup>? linkGroups})
      : linkGroups = linkGroups ?? [];

  factory JiraSoftwareOperations.fromJson(Map<String, Object?> json) {
    return JiraSoftwareOperations(
  ...
  JiraSoftwareOperations copyWith({List<LinkGroup>? linkGroups}) {
    return JiraSoftwareOperations(
...
class JiraSoftwareSimpleLink {
  ...
  factory JiraSoftwareSimpleLink.fromJson(Map<String, Object?> json) {
    return JiraSoftwareSimpleLink(
  ...
  JiraSoftwareSimpleLink copyWith(
      {String? href,
      String? iconClass,
      String? id,
      String? label,
...
/// A status category.
class JiraSoftwareStatusCategory {
  ...
  JiraSoftwareStatusCategory(
      {this.colorName, this.id, this.key, this.name, this.self});

  factory JiraSoftwareStatusCategory.fromJson(Map<String, Object?> json) {
    return JiraSoftwareStatusCategory(
  ...
  JiraSoftwareStatusCategory copyWith(
...
/// A status.
class JiraSoftwareStatusDetails {
  ...
  factory JiraSoftwareStatusDetails.fromJson(Map<String, Object?> json) {
    return JiraSoftwareStatusDetails(
      description: json[r'description'] as String?,
  ...
  JiraSoftwareStatusDetails copyWith(
      {String? description,
      String? iconUrl,
      String? id,
      String? name,
...
class JiraSoftwareUserDetails {
  ...
  factory JiraSoftwareUserDetails.fromJson(Map<String, Object?> json) {
    return JiraSoftwareUserDetails(
      accountId: json[r'accountId'] as String?,
  ...
  JiraSoftwareUserDetails copyWith(
      {String? accountId,
      String? accountType,
      bool? active,
      Map<String, dynamic>? avatarUrls,
...
class SearchResults {
  ...
  final List<JiraSoftwareIssueBean> issues;
  ...
  SearchResults(
      {this.expand,
      List<JiraSoftwareIssueBean>? issues,
      this.maxResults,
      this.names,
      this.schema,
      this.startAt,
  ...
  factory SearchResults.fromJson(Map<String, Object?> json) {
    return SearchResults(
      expand: json[r'expand'] as String?,
      issues: (json[r'issues'] as List<Object?>?)
              ?.map((i) => JiraSoftwareIssueBean.fromJson(
                  i as Map<String, Object?>? ?? const {}))
              .toList() ??
          [],
      maxResults: (json[r'maxResults'] as num?)?.toInt(),
...
class ServiceIdOrKeysAssociation {
  /// Defines the association type.
  final ServiceIdOrKeysAssociationAssociationType associationType;
  ...
  factory ServiceIdOrKeysAssociation.fromJson(Map<String, Object?> json) {
    return ServiceIdOrKeysAssociation(
      associationType: ServiceIdOrKeysAssociationAssociationType.fromValue(
          json[r'associationType'] as String? ?? ''),
      values: (json[r'values'] as List<Object?>?)
              ?.map((i) => i as String? ?? '')
              .toList() ??
  ...
  ServiceIdOrKeysAssociation copyWith(
      {ServiceIdOrKeysAssociationAssociationType? associationType,
      List<String>? values}) {
    return ServiceIdOrKeysAssociation(
      associationType: associationType ?? this.associationType,
      values: values ?? this.values,
...
class ServiceIdOrKeysAssociationAssociationType {
  static const serviceIdOrKeys =
      ServiceIdOrKeysAssociationAssociationType._('serviceIdOrKeys');
  ...
  const ServiceIdOrKeysAssociationAssociationType._(this.value);

  static ServiceIdOrKeysAssociationAssociationType fromValue(String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => ServiceIdOrKeysAssociationAssociationType._(value));
